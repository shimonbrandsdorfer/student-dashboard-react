        ...
        <main className="flex-1 p-8">
          <div className="max-w-7xl mx-auto">
            ...
            <header className="flex flex-wrap justify-between items-center gap-4 mb-8">
              ...
              <button className="flex min-w-[84px] items-center justify-center rounded-lg h-12 px-6 bg-cyan text-white text-sm font-bold leading-normal tracking-wide shadow-sm hover:bg-cyan/90 transition-colors">
                  ...
                  <form className="space-y-6">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="border border-gray-300 rounded focus-within:ring-2 focus-within:ring-cyan/50 focus-within:border-cyan">
                        <div className="flex items-center gap-2 p-2 border-b border-gray-300 bg-gray-50 rounded-t">
                          <button className="p-1.5 rounded hover:bg-gray-200" type="button"><span className="material-symbols-outlined text-lg text-gray-600">format_bold</span></button>
                          <button className="p-1.5 rounded hover:bg-gray-200" type="button"><span className="material-symbols-outlined text-lg text-gray-600">format_italic</span></button>
                          <button className="p-1.5 rounded hover:bg-gray-200" type="button"><span className="material-symbols-outlined text-lg text-gray-600">format_underlined</span></button>
                          <div className="w-px h-5 bg-gray-300 mx-1"></div>
                          <button className="p-1.5 rounded hover:bg-gray-200" type="button"><span className="material-symbols-outlined text-lg text-gray-600">format_list_bulleted</span></button>
                          <button className="p-1.5 rounded hover:bg-gray-200" type="button"><span className="material-symbols-outlined text-lg text-gray-600">format_list_numbered</span></button>
                          <div className="w-px h-5 bg-gray-300 mx-1"></div>
                          <button className="p-1.5 rounded hover:bg-gray-200" type="button"><span className="material-symbols-outlined text-lg text-gray-600">link</span></button>
                        </div>
                    ...
                    <div className="flex flex-col">
                     ...
                     {/* Scheduler  */}
                    <label className="flex flex-col">
                      <p className="text-charcoal text-base font-medium leading-normal pb-2">Schedule</p>
                      <div className="relative">
                        <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">calendar_today</span>
                        <input className="form-input flex w-full max-w-xs min-w-0 flex-1 resize-none overflow-hidden rounded text-charcoal focus:outline-0 focus:ring-2 focus:ring-cyan/50 border border-gray-300 bg-white focus:border-cyan h-12 placeholder:text-gray-400 pl-10 pr-3 py-3 text-base font-normal leading-normal" type="datetime-local" value="" />
                      </div>
                      <p className="text-sm text-gray-500 mt-1">Leave blank to post now.</p>
                    </label>
                     {/* Action Buttons  */}
                    <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
                      <button className="flex min-w-[84px] items-center justify-center rounded-lg h-11 px-5 bg-gray-100 text-charcoal text-sm font-bold leading-normal tracking-wide hover:bg-gray-200 transition-colors" type="button">
                        <span className="truncate">Save Draft</span>
                      </button>
                      <button className="flex min-w-[84px] items-center justify-center rounded-lg h-11 px-5 bg-cyan text-white text-sm font-bold leading-normal tracking-wide shadow-sm hover:bg-cyan/90 transition-colors" type="button">
                ...
                <div className="bg-white p-6 rounded-lg shadow-subtle h-full">
                  ...
                  <div className="flex gap-4 mb-4">
                    <div className="relative flex-grow">
                      ...
                      <input className="form-input w-full rounded border-gray-300 h-10 pl-10 focus:ring-cyan/50 focus:border-cyan" placeholder="Search announcements..." type="text" />
                    </div>
                 ...
                 {/* Announcements List  */}
                  <ul className="space-y-4">
                    <li className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                      <div className="flex justify-between items-start">
                        <div>
                          <h3 className="font-bold text-charcoal">Parent-Teacher Conference Sign-ups</h3>
                          <p className="text-sm text-gray-500 mt-1 line-clamp-2">Sign-ups are now available for the upcoming conferences. Please select a time slot at your earliest convenience to discuss your child&#39;s progress...</p>
                        </div>
                      ...
                      <div className="flex items-center gap-2 mt-3 text-xs">
                        <span className="inline-flex items-center font-semibold px-2 py-0.5 rounded-full bg-cyan/10 text-cyan">Published</span>
                        <span className="inline-flex items-center font-semibold px-2 py-0.5 rounded-full bg-magenta/10 text-magenta">Global</span>
                        <span className="text-gray-400 ml-auto">Oct 26, 2023</span>
                      </div>
                    </li>
                    <li className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                      <div className="flex justify-between items-start">
                        <div>
                          <h3 className="font-bold text-charcoal">Reminder: Science Fair Project Due</h3>
                          <p className="text-sm text-gray-500 mt-1 line-clamp-2">Just a friendly reminder that all Science Fair projects are due this Friday. Please ensure all components are labeled clearly.</p>
                        </div>
                        <button className="text-gray-500 hover:text-charcoal p-1">
                          <span className="material-symbols-outlined">more_vert</span>
                        </button>
                      ...
                      <div className="flex items-center gap-2 mt-3 text-xs">
                        <span className="inline-flex items-center font-semibold px-2 py-0.5 rounded-full bg-cyan/10 text-cyan">Published</span>
                        <span className="inline-flex items-center font-semibold px-2 py-0.5 rounded-full bg-gray-100 text-gray-600">Class-wide</span>
                        <span className="text-gray-400 ml-auto">Oct 22, 2023</span>
                      </div>
                    </li>
                    <li className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                      <div className="flex justify-between items-start">
                        <div>
                          <h3 className="font-bold text-charcoal">School Play Audition Info</h3>
                          <p className="text-sm text-gray-500 mt-1 line-clamp-2">Draft for the upcoming school play. Auditions will be held next week in the auditorium.</p>
                        </div>
                        <button className="text-gray-500 hover:text-charcoal p-1">
                          <span className="material-symbols-outlined">more_vert</span>
                        </button>
                      ...
                      <div className="flex items-center gap-2 mt-3 text-xs">
                        <span className="inline-flex items-center font-semibold px-2 py-0.5 rounded-full bg-gray-100 text-gray-600">Draft</span>
                        <span className="text-gray-400 ml-auto">Saved Oct 20, 2023</span>
                      </div>
                    </li>
                  </ul>
                </div>
